...
#GIVER_ADDRESS=0:91a8f6463a4ccdc0ceccd6d798cc44d025d1f71b0e6f54a9a25870fc8b16bf6a
...
#purchaseListCode=$(base64 ShoppingList.tvc)

$tos --url $NETWORK call $DEBOT_ADDRESS setShoppingListStateInit ShoppingList.decode.json \
    --sign $DEBOT_NAME.keys.json \
    --abi $DEBOT_NAME.abi.json # 1>/dev/null
